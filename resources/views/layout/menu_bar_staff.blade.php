    ...
    <body class="nav-sm">
        <div class="container body">
            <div class="main_container">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    ...
                                    <li><a href="booking.php"><i class="fa fa-calendar"></i> Daftar Booking <span class="fa fa-chevron-down"></span></a>
                                    </li>
                                    <li><a href="requestBooking.php"><i class="fa fa-book"></i> Permintaan Booking <span class="fa fa-chevron-down"></span></a>
                                    </li>
                ...
                <!-- top navigation-- masih mau diedit-->
                <div class="top_nav">
                    <div class="nav_menu">
                        <nav>
